...
const projects = [
  {
    ...
    status: "Concept",
    liveUrl: "#",
    githubUrl: "https://github.com/nouralachgar-cyber/bloom",
  },
  {
    ...
    status: "Live",
    liveUrl: "https://nebras-coffee-f8i2x84qk-noura-lachgar.vercel.app",
    githubUrl: "https://github.com/nouralachgar-cyber/nebras-coffee",
    image: "/nebras.png",
  },
  {
    ...
    status: "In Progress",
    liveUrl: "#",
    githubUrl: "https://github.com/nouralachgar-cyber/taskflow",
  },
]
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-10 lg:mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            ...
            >
              {project.image ? (
                <img src={project.image} alt={project.title} className="w-full h-48 object-cover object-top rounded-t-xl" />
              ) : (
                <div className={`h-44 lg:h-48 bg-gradient-to-br ${project.gradient} relative p-5 flex flex-col justify-between overflow-hidden`}>
              ...
              <div className="p-6 flex flex-col flex-1 gap-3">
                <h3 className="font-display font-semibold text-white text-[16px] leading-tight tracking-tight">{project.title}</h3>
                <p className="text-[13.5px] leading-6 text-zinc-400 flex-1">{project.description}</p>
                ...
                <div className="mt-2 flex gap-2">
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="flex-1">
                    <Button variant="secondary" size="sm" className="w-full rounded-full h-9 text-xs font-semibold bg-white/[0.06] border-white/10 hover:bg-white hover:text-zinc-900 hover:border-white transition-colors">
                      <Github className="h-3.5 w-3.5" /> Code
                    </Button>
                  </a>
                  <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="flex-1">
                    <Button variant="default" size="sm" className="w-full rounded-full h-9 text-xs font-semibold">
